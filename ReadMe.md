 ...
 **H**earth**s**tone **Mod**ification Based on BepInEx, the plugin source code is located at [github](https://github.com/Gying091/HsMod)[.](https://github.com/Gying091/HsMod)[com](https://github.com/Gying091/HsMod)[/](https://github.com/Gying091/HsMod)[Pik](https://github.com/Gying091/HsMod)[-](https://github.com/Gying091/HsMod)[4](https://github.com/Gying091/HsMod)[/](https://github.com/Gying091/HsMod)[HsMod](https://github.com/Gying091/HsMod), the plugin will not collect any information about you; the project follows `AGPL-3.0`, and is used for learning and research only.

HsMod plans to develop web-based configuration management. If you are interested, you can check [#122](https://github.com/Gying091/HsMod/discussions/122)
...
git clone --depth 1 --branch bepinex5 https://github.com/Gying091/HsMod
cd HsMod
...
8. Download the HsMod [Releases](https://github.com/Gying091/HsMod/releases) and unzip to `Hearthstone/BepInEx/plugins`
...
8. When a problem occurs first try to delete the relevant `.cfg` configuration file (usually located in `BepInEx\config\` ) and reconfigure; if the problem still exists, please bring `HsMod.cfg` to submit [Issues](https://github.com/Gying091/HsMod/issues), but there is no guarantee of a timely answer.
9. `GetHsLib.py` is used to update Hearthstone's own runtime libraries, and `install.bat` is used to copy the compiled `HsMod.dll` to the default Hearthstone directory (provided BepInEx has been configured). In addition, after push changes the version number (after PluginInfo.cs changes), [a release](https://github.com/Gying091/HsMod/releases) is automatically generated.
